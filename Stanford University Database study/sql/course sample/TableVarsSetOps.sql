...
/*** this may have pair with repeat in reverse order such as (yang,zhang) and (zhang,yang) ***/
select S1.sID, S1.sName, S1.GPA, S2.sID, S2.sName, S2.GPA
from Student S1, Student S2
where S1.GPA = S2.GPA and S1.sID <> S2.sID;

/*** Get rid of reverse-pairings ***/
/** only have distinct pairs**/
select S1.sID, S1.sName, S1.GPA, S2.sID, S2.sName, S2.GPA
from Student S1, Student S2
where S1.GPA = S2.GPA and S1.sID < S2.sID;
...
select S1.sID as student1ID, S1.sName as student1Name ,S2.sID as student2ID,S2.sName as student2Name
from Student S1, Student S2
where S1.GPA = S2.GPA and S1.sID < S2.sID;
