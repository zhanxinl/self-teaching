...
as the query processor does the join, it should be applying all the conditions.
When we make this a where,
it's sort of a hint saying,
here's the condition that really applies to the combination of the tuples,
and the rest of the conditions apply to separate attributes.
*******************************/
